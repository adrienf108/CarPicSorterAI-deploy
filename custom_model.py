...
class CustomModel:
    ...
    def __init__(self):
        ...
        self.main_categories = [
            'Exterior', 'Interior', 'Engine', 'Undercarriage', 'Documents'
        ]
        self.subcategories = {
            'Exterior': [
                '3/4 front view', 'Side profile', '3/4 rear view', 'Rear view',
                'Wheels', 'Details', 'Defects'
            ],
            'Interior': [
                'Full interior view', 'Dashboard', 'Front seats',
                "Driver's seat", 'Rear seats', 'Steering wheel', 'Gear shift',
                'Pedals and floor mats', 'Gauges/Instrument cluster',
                'Details', 'Trunk/Boot'
            ],
            'Engine': ['Full view', 'Detail'],
            'Undercarriage': ['Undercarriage'],
            'Documents': [
                'Invoices/Receipts', 'Service book',
                'Technical inspections/MOT certificates'
            ]
        }
...
{{
        ...
        try:
            ...
            try:
                ...
                if isinstance(result, dict) and all(
                    ...
                    ['main_category', 'subcategory', 'confidence']):
                    ...
                    if main_category != 'Uncategorized' and subcategory not in self.subcategories[
                            main_category]:
                        return 'Uncategorized', 'Uncategorized', 0.0, token_usage, image_size
    ...
    def learn_from_manual_categorization(self, image, main_category,
                                         subcategory):
